...
const FeaturesSectionDemo = () => {
  const features = [
    {
      title: "User Friendly",
      description: "User can doante blood easily with the help of just a single click.",
      icon: <IconTerminal2 />,
    },
    {
      title: "Ease of use",
    ...
    {
      title: "Booking Free PLatform",
      description: " No cap, no lock, no credit card required.",
      icon: <IconCurrencyDollar />,
    },
    {
      title: "Helping India Grow",
      description: "We just cannot be taken down by anyone.",
      icon: <IconCloud />,
    },
    {
      title: "Multi-tenant Architecture",
      description: "You can orgainize any amount of  camp with us.",
    ...
    },
    {
      ...
      description: "If you donot likeany of our service, we will convince you to like us.",
